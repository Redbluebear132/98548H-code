...
Left.setVelocity(60,pct);
  ...
  Flywheel.setVelocity(95,pct);
  HDRIVE.driveFor(forward,1,inches);
  Intake.spinFor(reverse,110,degrees);
  HDRIVE.driveFor(reverse,5,inches);
  HDRIVE.turnFor(right,135,degrees);
  Intake.spin(forward);
  HDRIVE.setDriveVelocity(30,pct);
  HDRIVE.driveFor(forward,5,inches);
  Flywheel.spin(forward);
  wait(0.3,sec);
  HDRIVE.driveFor(reverse,5,inches);
  HDRIVE.turnFor(left,90,degrees);
  Intake.stop();
  HDRIVE.driveFor(reverse,20,inches);
  HDRIVE.turnFor(left,65,degrees);
  wait(0.3,sec);
  INDEXER.set(true);
  wait(0.5,sec);
  INDEXER.set(false);
