...
motor FL = motor(PORT16, ratio6_1, false);
motor BL = motor(PORT14, ratio6_1, false);
motor FR = motor(PORT17, ratio6_1, true);
motor BR = motor(PORT19, ratio6_1, true);
...
motor FlywheelMotorB = motor(PORT13, ratio6_1, false);
