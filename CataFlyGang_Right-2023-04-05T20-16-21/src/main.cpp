...
void autonomous(void) {
  ...
  Flywheel.setVelocity(92,pct);
  HDRIVE.driveFor(forward,31,inches);
  Flywheel.spin(forward);
  HDRIVE.turnFor(right,90,degrees);
  HDRIVE.driveFor(forward,6.7,inches,false);
  wait(1.1,sec);
  Intake.spinFor(reverse,125,degrees,false);
  wait(0.5,sec);
  HDRIVE.driveFor(reverse,2,inches);
  HDRIVE.turnFor(right,4,degrees);
  wait(0.53,sec);
  INDEXER.set(true);
  wait(0.5,sec);
  INDEXER.set(false);
  ...
  wait(0.4,sec);
  INDEXER.set(false);
  HDRIVE.turnFor(right,126,degrees);
  ...
  HDRIVE.turnFor(left,110,degrees);
  wait(0.2,sec);
  INDEXER.set(true);
  wait(0.5,sec);
  INDEXER.set(false);
